...
namespace Prueba5.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        #region AutoComplete
        [HttpPost]
        public JsonResult GetComplete(string valorEntrada)
        {
            TranSapoContext db = new TranSapoContext();
            var recorridoparadero = from RecorridosParadero rp in db.recorridosParadero
                                    select rp;
            List<Obj> posibilidades = new List<Obj>();
            int i = 0;
            foreach (RecorridosParadero rp in recorridoparadero)
            {
                string r = rp.Recorrido.numero;
                string p = rp.Paradero.codigo;
                posibilidades.Add(new Obj { ID = i++, Datos = "V " + p + " " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = "LL " + p + " " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = "PA " + p + " " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = "D " + p + " " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = "PR " + p + " " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = "V " + r + " " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = "LL " + r + " " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = "PA " + r + " " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = "D " + r + " " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = "PR " + r + " " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " " + r + " " + "V" });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " " + r + " " + "LL" });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " " + r + " " + "PA" });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " " + r + " " + "D" });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " " + r + " " + "PR" });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " " + p + " " + "V" });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " " + p + " " + "LL" });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " " + p + " " + "PA" });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " " + p + " " + "D" });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " " + p + " " + "PR" });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " V " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " F " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " LL " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " LL " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " PA " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " PA " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " D " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " D " + r });
                posibilidades.Add(new Obj { ID = i++, Datos = r + " PR " + p });
                posibilidades.Add(new Obj { ID = i++, Datos = p + " PR " + r });
            }
            if (valorEntrada != null)
            {
                var consulta = from t in posibilidades
                               where t.Datos.ToUpper().StartsWith(valorEntrada.ToUpper())
                               select t;
